...
<?if (!empty($arResult)):?>
    <div class="catalog-btn">
        <div class="catalog-burger"><span></span></div>
        Каталог товаров<svg  width="11" height="7" class="icon arrow"><use xlink:href="#angle-right"></use></svg>
        <div class="over-submenu"></div>
        <div class="over-sub-submenu"></div>
        <nav class="catalogProducts">
