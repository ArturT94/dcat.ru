...
<script type="text/javascript">
		...
		<div class="col-12">
			<div class="cart-table">
				<div class="table-row table-head">
					<div class="cell cell-delete">Удалить</div>
					<div class="cell cell-thumb">Изображение</div>
					<div class="cell cell-title">Название</div>
					<div class="cell cell-price">Цена</div>
					<div class="cell cell-quantity">Количество</div>
					<div class="cell cell-total">Всего</div>
				</div>
	...
	{?>
		<div class="empty-order ta-left col-12">
			<div class="description">Добавьте товар в корзину. У нас все очень вкусное.</div>
		</div>
	<?}?>
