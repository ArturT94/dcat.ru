        ...
        foreach($arResult as $arItem):?>
            ...
            <?if ($arItem["IS_PARENT"]):?>
                <?if ($arItem["DEPTH_LEVEL"] == 1):?>
                    <li class="has-submenu menu<?if ($arItem["SELECTED"]):?> item-selected<?endif?>">
                        <a href="<?=$arItem["LINK"]?>" class="category-menu-link catalog-menu-link">
                            <?=$arItem["TEXT"]?>
                            <svg width="11" height="7" class="icon arrow"><use xlink:href="#angle-right"></use></svg>
                        </a>
                         <ul class="submenu submenu-top">
                <?else:?>
                    <li class="has-submenu submenu-item<?if ($arItem["SELECTED"]):?> item-selected<?endif?>">
                        <a class="submenu-item-link<?if ($arItem["SELECTED"]):?> selected<?endif?>" href="<?=$arItem["LINK"]?>">
                            <?=$arItem["TEXT"]?>
                            <svg width="11" height="7" class="icon arrow"><use xlink:href="#angle-right"></use></svg>
                        </a>
