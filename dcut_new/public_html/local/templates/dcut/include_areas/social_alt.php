<a href="https://vk.com/ooo_dcut" target="_blank">
    <svg width="19" height="19" class="icon"><use xlink:href="#vk-square"></use></svg>
</a>
<a href="https://www.youtube.com/channel/UCL4whMd7Owzoq7jDt8IqImQ" target="_blank">
    <svg width="20" height="19" class="icon"><use xlink:href="#youtube-square"></use></svg>
</a>
<a href="https://www.facebook.com/groups/ooodcut" target="_blank">
    <svg width="20" height="19" class="icon"><use xlink:href="#facebook-square"></use></svg>
</a>
<a href="https://www.instagram.com/ooo_dcut/" target="_blank">
