...
if($arParams['USER_NAME']){
    $arResult['JS_OBJECT']['FIELDS']['USER_NAME'] = $arParams['USER_NAME'];
}
if($arParams['USER_ID']){
    $arResult['JS_OBJECT']['FIELDS']['USER_ID'] = $arParams['USER_ID'];
}
if($arParams['USER_GUID']){
    $arResult['JS_OBJECT']['FIELDS']['USER_GUID'] = $arParams['USER_GUID'];
}
